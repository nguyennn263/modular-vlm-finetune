...
CELLS = [
    ...
    code("# full training run (whole dataset)",
         "!python -m src.cli.train --bridge residual --output-dir /kaggle/working/checkpoints"),
    code("# resume in a later session (auto-picks newest step_*.pt):",
    ...
    code("!python -m src.cli.evaluate --bridge residual \\",
         "    --checkpoint /kaggle/working/checkpoints/residual/best_model.pt --split val"),
    md("### Other bridges",
       "",
