...
\begin{table}[t]
  ...
  \begin{tabular}{@{}lcc p{5.1cm}@{}}
    \toprule
    Bridge & $k$ tokens & Trainable params & Mechanism \\
    \midrule
    Residual        & 1  & 4.86\,M (0.52\,\%) & linear projector $+$ LayerNorm/GELU residual \\
    \textbf{Multi-Token} & 8  & 7.35\,M (0.78\,\%) & mean-pooled patches $\rightarrow$ 8 tokens (1 anchor, 7 semantic) \\
...
(\texttt{align-logit}), with weight $\alpha$ on the KD term; for
\texttt{align-logit} we sweep $\alpha \in \{0.1, 1.0\}$.
