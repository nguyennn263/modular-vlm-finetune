...
(alignment is an exact null across two KD variants). The only lever that helps is a small LoRA on the
...
bridges into a $0.9$-point F1 band. For this VLM class, the ceiling on
