...
echo "  - python scripts/base_exp.py              : Run base experiment (better_mlp)"
echo "  - python scripts/exp1_better_mlp.py       : Experiment 1 - BetterMLP"
echo "  - python scripts/exp2_multi_token.py      : Experiment 2 - MultiToken"
echo "  - python scripts/exp3_attention_bridge.py : Experiment 3 - AttentionBridge"
