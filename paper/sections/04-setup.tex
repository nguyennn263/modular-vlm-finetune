...
an in-house scorer whose values match the AutoViVQA baseline table. The two
metric conventions are kept in separate tables (in-house
Table~\ref{tab:main-inhouse}, corpus Table~\ref{tab:main-corpus}). Main
